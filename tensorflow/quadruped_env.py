...
class AllJoints:
    def __init__(self,joint_name_lst):
        self.jta = actionlib.SimpleActionClient('/open_critter/joint_trajectory_controller/follow_joint_trajectory',
                                                FollowJointTrajectoryAction)
        rospy.loginfo('Waiting for joint trajectory action')
        self.jta.wait_for_server()
        rospy.loginfo('Found joint trajectory action!')
        self.jtp = rospy.Publisher('/open_critter/joint_trajectory_controller/command',JointTrajectory,queue_size=1)
...
class QuadrupedEnvironment:
    def __init__(self):
        ...
        self.link_name_lst = ['open_critter::base_link',
                             'open_critter::front_right_coxa_link', 'open_critter::front_right_femur_link', 'open_critter::front_right_tibia_link',
                             'open_critter::front_left_coxa_link', 'open_critter::front_left_femur_link', 'open_critter::front_left_tibia_link',
                             'open_critter::rear_right_coxa_link', 'open_critter::rear_right_femur_link', 'open_critter::rear_right_tibia_link',
                             'open_critter::rear_left_coxa_link', 'open_critter::rear_left_femur_link', 'open_critter::rear_left_tibia_link']
        self.leg_link_name_lst = self.link_name_lst[1:]
        self.joint_name_lst = [      'front_right_coxa_joint', 'front_right_femur_joint', 'front_right_tibia_joint',
        ...
        self.model_config_req.model_name = 'open_critter'
        ...
        self.model_state_req.model_state.model_name = 'open_critter'
        ...
        self.get_model_state_req.model_name = 'open_critter'
        ...
        self.joint_state_subscriber = rospy.Subscriber('/open_critter/joint_states',JointState,
                                                       self.joint_state_subscriber_callback)
        self.orientation = np.zeros(4)
        self.angular_vel = np.zeros(3)
        self.linear_acc = np.zeros(3)
        self.imu_subscriber = rospy.Subscriber('/open_critter/imu',Imu,
